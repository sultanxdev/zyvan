# Design System: Lime & Obsidian

> **Query**: "Lime & Obsidian (User)" | **Tech Stack**: nextjs | **Generated**: 3/9/2026

## 01. Foundation
- **Primary Color**: `#09090B` ![#09090B](https://via.placeholder.com/15/09090B/000000?text=+)
- **Typography**: **Merriweather** (Headings & Body)
...
| **100** | `#E2E2E9` | ![#E2E2E9](https://via.placeholder.com/80x30/E2E2E9/E2E2E9?text=+) |
| **200** | `#C7C7D1` | ![#C7C7D1](https://via.placeholder.com/80x30/C7C7D1/C7C7D1?text=+) |
| **300** | `#ABABBA` | ![#ABABBA](https://via.placeholder.com/80x30/ABABBA/ABABBA?text=+) |
| **400** | `#8F8FA3` | ![#8F8FA3](https://via.placeholder.com/80x30/8F8FA3/8F8FA3?text=+) |
| **500** | `#73738C` | ![#73738C](https://via.placeholder.com/80x30/73738C/73738C?text=+) |
| **600** | `#5C5C70` | ![#5C5C70](https://via.placeholder.com/80x30/5C5C70/5C5C70?text=+) |
| **700** | `#454554` | ![#454554](https://via.placeholder.com/80x30/454554/454554?text=+) |
| **800** | `#2E2E38` | ![#2E2E38](https://via.placeholder.com/80x30/2E2E38/2E2E38?text=+) |
| **900** | `#16161D` | ![#16161D](https://via.placeholder.com/80x30/16161D/16161D?text=+) |

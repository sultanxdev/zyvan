...
import { ArrowLeft01Icon, LockKeyIcon, Mail01Icon, UserIcon } from '@hugeicons/core-free-icons';
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <div className="flex flex-col items-center text-center space-y-2">
          ...
          <p className="text-xs text-muted-foreground">
            Deploy at-least-once webhook infrastructure in 2 minutes
          </p>
        </div>
        ...
        <div className="bg-white border border-border/80 rounded-2xl p-6 sm:p-8 shadow-xl shadow-black/5 space-y-5">
          ...
          <div className="space-y-2.5">
            ...
            >
              ...
              <span>{loadingAction === 'google' ? 'Connecting to Google...' : 'Sign up with Google'}</span>
            </button>
            ...
            >
              ...
              <span>{loadingAction === 'github' ? 'Connecting to GitHub...' : 'Sign up with GitHub'}</span>
            </button>
          </div>
          ...
          <form onSubmit={handleSignupSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <Icon icon={UserIcon} size={16} className="absolute left-3 top-3 text-zinc-400" />
                <input
                  type="text"
                  value={name}
            ...
            >
              {loadingAction === 'email' ? 'Creating Account...' : 'Create Developer Account'}
            </Button>
          </form>
        </div>
        ...
        <p className="text-center text-xs text-muted-foreground">
          ...
          <Link href="/login" className="text-foreground font-semibold underline underline-offset-4 hover:text-black">
            Sign in
          </Link>
        </p>
      </div>

...
export function EndpointBadge({
  ...
  return (
    <div className="my-6 flex flex-wrap items-center justify-between gap-3 rounded-xl border border-white/10 bg-zinc-950/80 p-3 backdrop-blur-md shadow-lg font-mono">
      ...
      <div className="flex items-center gap-2.5">
        {auth && (
          <div className="flex items-center gap-1.5 rounded-md bg-zinc-900 border border-zinc-800 px-2 py-1 text-[11px] text-zinc-400 font-sans">
        ...
        <button
          ...
          className="flex items-center gap-1 rounded-md border border-white/10 bg-white/5 px-2 py-1 text-xs text-zinc-400 hover:text-zinc-200 hover:bg-white/10 transition-all active:scale-95"
        >
          {copied ? (
